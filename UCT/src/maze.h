...
class Maze{
    ...
    public:
        ...
        /* 
         * These functions are used in MCTS/UCT planning
         */
        bool Step(State& s, int action, double& reward) const; //Step function for generative planning
        int SelectRandom(State& s) const; //Return random action for rollouts
        /*
